...
#endif
    {
        ...
        private static void ConfigureImportSettings()
        {
            ...
            try
            {
                ...
                if (AssemblyImportSettingsUtilitiesCustom.IsJITSupported(
                    platform,
                    AssemblyImportSettingsUtilitiesCustom.GetCurrentScriptingBackend(),
                    AssemblyImportSettingsUtilitiesCustom.GetCurrentApiCompatibilityLevel()))
                {
        ...
        private static void ApplyImportSettings(BuildTarget platform, string[] assemblyPaths, OdinAssemblyImportSettings importSettings)
        {
            ...
            {
                AssemblyImportSettingsUtilitiesCustom.SetAssemblyImportSettings(platform, assemblyPaths[i], importSettings);
            }
        }
